...
from dataset_functions import seq_to_singleton_format, load_dataset
...
dataset_name = "ff7_transposed" # Change to name of your dataset
folder_name = "./" + dataset_name + "_len{}_stride{}".format(SEQ_LEN,STRIDE)
...
doc = []
doc.append("Dataset type:\t\t\t"+dataset_name)
...
train_data = load_dataset("{}.npz".format(dataset_name), SEQ_LEN+1, STRIDE+1)
